...
public class PrometeoEditor : Editor
{
    ...
    //
    //
    private SerializedProperty bodyRenderer;
    ...
    private void OnEnable()
    {
        ...
        bodyRenderer = SO.FindProperty("bodyRenderer");
    ...
    public override void OnInspectorGUI()
    {
        ...
        EditorGUILayout.PropertyField(bodyRenderer, new GUIContent("Body Renderer: "));
