...
public class TrackPieceManager : EditorWindow
{
    ...
    [MenuItem("Labster/TrackPieceManager")]
    public static void ShowExample()
    {
        TrackPieceManager window = GetWindow<TrackPieceManager>();
        window.titleContent = new GUIContent("Track Piece Manager");
    }
    ...
    {
        TrackPieceScriptable track = CreateInstance<TrackPieceScriptable>();
    ...
    private void InstantiateGhost()
    {
        ...
        currentPieceGhost = Instantiate(piece.Prefab);
